...
const automataDesc = () => {
    return (
        ...
        <p>Features several screens, including a menu where the user can select the Game of Life, Day and Night or be taken to the setup screen for their own automata. The customisation screen features widgets I created myself using PyGame's basic shape drawing tools, such as sliders and basic check boxes.</p>
...
const pysoreDesc = () => {
    return (
        ...
        <p>Has a menu screen alongside the main photo screen, with a collapsable menu where filters can be selected. Users can save images with filters applied.</p>
...
function ProjectsBox() {
    return (
        <div className="ProjectsBoxContainer">
            <Project title="Cellular Automata" content={automataDesc()} image="https://github.com/CZboop/Cellular-Automata/blob/main/images/automata%20running.gif?raw=true" link="https://github.com/CZboop/Cellular-Automata"/>
            <Project title="Langton's Ant" content={langtonDesc()} image="https://github.com/CZboop/Langtons-Ant/blob/main/antimation.gif?raw=true" link="https://github.com/CZboop/Langton"/>
            <Project title="PyScrabble" content={scrabbleDesc()} image="https://github.com/CZboop/PyScrabble/blob/main/scrabble_game.jpg?raw=true" link="https://github.com/CZboop/PyScrabble"/>
            <Project title="PySore" content={pysoreDesc()} image={"https://github.com/CZboop/pySore/blob/main/save_from_app_demo.jpg?raw=true"} link="https://github.com/CZboop/pySore"/>
            <Project title="Mini Projects & More!" content={miniProjDesc()} image={"https://github.com/CZboop/Webcam-Theremin/blob/main/synth_spidey.png?raw=true"} link="https://github.com/CZboop"/>
        </div>
    )
}
